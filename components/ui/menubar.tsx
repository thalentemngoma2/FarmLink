...
export const Menubar: React.FC<MenubarProps> = ({ children, style }) => {
  ...
  return (
    <MenubarContext.Provider value={value}>
      <View style={StyleSheet.flatten([styles.menubar, style])}>
        {children}
      </View>
  ...
  return (
    ...
    >
      <View style={styles.itemContent}>
        ...
        <Text
          style={StyleSheet.flatten([styles.itemText, { color: textColor }])}
        >
          {children}
        </Text>
...
export const MenubarLabel: React.FC<{
  ...
  <Text style={StyleSheet.flatten([styles.label, inset && styles.labelInset])}>
    {children}
  </Text>
);
...
// MenubarShortcut
// -----------------------------------------------------------------------------
export const MenubarShortcut: React.FC<{ children: ReactNode }> = ({
  children,
...
export const MenubarSubContent: React.FC<MenubarSubContentProps> = ({
  ...
  let left = position.x;
  if (left + dimensions.width > screenWidth)
    left = screenWidth - dimensions.width - 8;
  if (left < 8) left = 8;

  let top = position.y;
  if (top + dimensions.height > screenHeight)
    top = screenHeight - dimensions.height - 8;
  if (top < 8) top = 8;
...
// -----------------------------------------------------------------------------
export const MenubarPortal: React.FC<{ children: ReactNode }> = ({
  children,
}) => <>{children}</>;
export const MenubarGroup: React.FC<{ children: ReactNode }> = ({
  children,
}) => <>{children}</>;
