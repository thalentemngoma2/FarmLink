...
export default function PostTenderPage() {
  ...
  const withDemoFallback = <T,>(
    ...
    return Promise.race([
      ...
      new Promise<T | null>((resolve) =>
        setTimeout(() => {
          console.warn(
            "Demo Failsafe: Bypassing database wait to continue presentation.",
          );
          resolve(null);
        }, ms),
      ),
  ...
  const handleSubmit = async () => {
    ...
    if (
      ...
      showAlert(
        "Error",
        "Store Name, Title, Description, and Deadline are required.",
      );
      return;
    }
      ...
      const performSubmit = async () => {
        ...
        if (!userCheck) {
          ...
          if (userInsertError && userInsertError.code !== "23505") {
            ...
            throw new Error(
              `User profile creation failed: ${userInsertError.message}`,
            );
          }
        }
        ...
        >
          <Animated.View entering={FadeInUp}>
            <Text style={styles.subtitle}>
              Create a new supply contract opportunity for farmers.
            </Text>
              ...
              <View key={idx} style={styles.reqCard}>
                ...
                <View style={styles.row}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(v) =>
                      updateRequirement(idx, "gradeQuality", v)
                    }
                  />
                </View>
                <TextInput
          ...
          >
            <View style={styles.modalContent}>
              ...
              <Text style={styles.modalText}>
                Your tender is now live in the marketplace.
              </Text>
            </View>
          </Animated.View>
        </View>
