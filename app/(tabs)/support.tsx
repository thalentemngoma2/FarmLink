...
export default function SupportPage() {
  ...
  useEffect(() => {
    if (!user) {
      ...
      setPendingAction("access support");
    } else {
  ...
  const handleSupportSubmit = async () => {
    ...
    try {
      ...
      if (Platform.OS === "web") {
        window.alert(
          "Your support request has been sent to an extension officer.",
        );
      } else {
        Alert.alert(
          "Success",
  ...
  const handleDeleteRequest = (requestId: string) => {
    const performDelete = async () => {
      try {
        ...
        if (Platform.OS === "web") {
          window.alert(
            "Error: " + (error.message || "Could not delete request"),
          );
        } else {
    ...
    <View style={styles.requestItem}>
      ...
      >
        ...
        <Text style={styles.requestMeta}>
          {user?.role === "extension_officer" && item.farmer?.username
      ...
      <View style={{ alignItems: "flex-end", gap: 8 }}>
        <View
          style={[
            styles.statusBadge,
            (styles as any)[`status_${item.status}`] || styles.status_pending,
          ]}
        >
            ...
            {loading ? (
              ...
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptySubtitle}>
                  There are currently no farmer support requests.
                </Text>
              </View>
            ) : (
              <FlatList
      ...
      <SafeAreaView style={styles.safeArea} edges={["top", "left", "right"]}>
        <View style={styles.container}>
          ...
          >
            ...
            <Text style={styles.emptyTitle}>Support Required</Text>
            <Text style={styles.emptySubtitle}>
              Log in or create an account to send support requests to our
          ...
          <View style={styles.content}>
            ...
            {loading ? (
              ...
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptySubtitle}>
                  Tap the &apos;+&apos; button to send a request to an
      ...
      >
        ...
        >
          <Animated.View entering={FadeInUp}>
            ...
            >
              ...
              >
                Connect with an agricultural extension officer in your area for
                guidance, farm visits, and crop support.
              </Text>
            </View>
        ...
        <View style={styles.footer}>
          <TouchableOpacity
            style={[
              styles.submitButton,
              (!supportTitle.trim() || !supportDesc.trim()) &&
