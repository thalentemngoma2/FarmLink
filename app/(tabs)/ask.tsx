...
export default function AskPage() {
    ...
    try {
      ...
      for (let i = 0; i < mediaItems.length; i++) {
        ...
        try {
          ...
          Alert.alert(
            "Upload Error",
            err.message || "Failed to upload media. Please try again.",
          );
      ...
      Alert.alert(
        "Error",
        error.message || "Failed to post your question. Please try again.",
      );
    } finally {
  ...
  const pickMedia = async (mediaType: "image" | "video") => {
    ...
    if (!permission.granted) {
      Alert.alert(
        "Permission Required",
        `Please allow access to your ${mediaType}s.`,
      );
      return;
    }
          ...
          >
            <View style={styles.modalContent}>
              ...
              <Text style={styles.modalText}>
                The community will respond soon
              </Text>
            </View>
          </Animated.View>
        </View>
